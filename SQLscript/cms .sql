...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2020 at 04:42 AM
...
(21, 14, 'CSS selectors', 'Sam', '2020-06-03', 'css-illustration.png', '<p>You have met selectors already. A CSS selector is the first part of a CSS Rule. It is a pattern of elements and other terms that tell the browser which HTML elements should be selected to have the CSS property values inside the rule applied to them. The element or elements which are selected by the selector are referred to as the <i>subject of the selector</i>.</p><figure class=\"image\"><img src=\"https://mdn.mozillademos.org/files/16550/selector.png\" alt=\"Some code with the h1 highlighted.\"></figure><p>In earlier articles you met some different selectors, and learned that there are selectors that target the document in different ways — for example by selecting an element such as h1, or a class such as .special.</p><p>In CSS, selectors are defined in the CSS Selectors specification; like any other part of CSS they need to have support in browsers for them to work. The majority of selectors that you will come across are defined in the <a href=\"https://www.w3.org/TR/selectors-3/\">Level 3 Selectors specification</a>, which is a mature specification, therefore you will find excellent browser support for these selectors.</p>', 'css, selectors, cascading style sheet', 0, 'published');
...
--
ALTER TABLE `posts`
  MODIFY `post_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
