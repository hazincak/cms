             ...
             while($row = mysqli_fetch_assoc($select_posts_images)){
                 ...
                 <span class='js--image-block'>
                    <div class='col-md-1 text-center'>
                       <img class='img-thumbnail' style='width: 80%; min-height: 80px'   src='../images/postImages/$image_name'>
                       <button type='button' data-imageId=$image_id  data-imageName = '$image_name' class='btn btn-secondary btn-sm js--delete-image'>Delete</button>
                    </div>
                </span>";
             }
